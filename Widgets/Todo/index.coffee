...
# You must have a Todo.txt file in your Documents folder for this to work

command: "cat ~/Documents/Todo.txt"
...
update: (output, domElement) ->
  ...
  domElement.innerHTML = '<div class="container"><div class="widget-title">Todo list<br>----------------</div><div id="formulae" class="list"></div></div>'
